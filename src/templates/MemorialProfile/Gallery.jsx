      ...
      try {
        ...
        const items = filteredList.map((item) => {
          ...
          if (isUrl && !isVideo && !isGif && url.includes('/image/upload/')) {
            ...
            thumbnail = `/images/${familyId}/thumbnails/${baseName}.jpg`
  ...
  if (galleryItems.length === 0) {
    return (
      <Card id="gallery">
        ...
        <EmptyState>
          Gallery images will be added soon. Please add images to the <code>public/images/{familyId}/</code> folder and update <code>public/images/{familyId}/images.json</code>.
        </EmptyState>
      </Card>
    )
  }
