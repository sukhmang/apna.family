      ...
      <DetailsList>
        <DetailItem>
          ...
          <DetailContent>
            ...
            <DetailValue>{event.displayDate || event.date}</DetailValue>
          </DetailContent>
        </DetailItem>
        ...
        <DetailItem>
          ...
          <DetailContent>
            ...
            <DetailValue>{event.displayTime || event.time}</DetailValue>
          </DetailContent>
        </DetailItem>
...
export default function Events() {
  ...
  const mainEvent = {
    ...
    date: eventData.displayDate,
    time: eventData.displayTime,
    venueName: eventData.venueName,
    address: eventData.address,
    isPast: eventData.isMainEventPast || false
  }

  // Separate past and current events
  const pastEvents = [
    mainEvent,
    ...(eventData.additionalEvents || []).filter(event => event.isPast)
  ]

  const currentEvents = (eventData.additionalEvents || []).filter(event => !event.isPast)
