...
export default function Stories() {
  ...
  const handleEmailSubmit = () => {
    ...
    const firstName = memorialData.name.split(' ')[0] || memorialData.name
  ...
  return (
    <Card id="stories">
      ...
      <Content>
        Share your memories and stories about {memorialData.name}. Stories will be displayed here soon.
      </Content>
    </Card>
  )
}
